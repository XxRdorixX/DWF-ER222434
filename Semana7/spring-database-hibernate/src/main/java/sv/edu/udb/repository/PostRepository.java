...
import org.hibernate.query.criteria.HibernateCriteriaBuilder; // NUEVO
import org.hibernate.query.criteria.JpaCriteriaQuery;          // NUEVO
...
public class PostRepository {
    ...
    // Creacion del metodo para con Criteria API buscar un POST por su titulo

    public List<Post> findByTitle(String title) { // NUEVO
        Session session = sessionFactory.getCurrentSession();
        HibernateCriteriaBuilder cb = session.getCriteriaBuilder();
        JpaCriteriaQuery<Post> query = cb.createQuery(Post.class);
